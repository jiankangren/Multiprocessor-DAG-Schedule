# - baseline 2b: to improve CPU utilization, take jobs from later in the schedule and run them earlier
# (go as far as you want, so focus on cpu utilization at the cost of breaking locality)
# but instead of forcing delayed tasks, push them to the end


from __future__ import division
import math

print "Start process of computing multi-processor schedule with baseline 2b"
...
def baseline2b(graph, pnum, tnum):
